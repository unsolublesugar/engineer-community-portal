...
- **登壇者詳細** — 登壇者ごとの全発表履歴・スライド・動画リンクをまとめたプロフィールページ
- **企画コーナー** — 特別企画のアーカイブ
...
title: 'LTイベント #1'
date: '2024-01-30'
event_url: https://example.connpass.com/event/000001/  # connpass / Doorkeeper / Peatix / TECH PLAY / Meetup を自動判定
youtube_url: ''
hashtag: '#MyLT'
talks:
- title: 発表タイトル
...
> SlideShare は anti-bot challenge により iframe 埋め込みが機能しないため、自動埋め込み対象外（外部リンクのみ）。
